...
## Arduino-cli JS wrapper

this library base on [arduino-cli npm](https://www.npmjs.com/package/arduino-cli).

I cannot find the github repository. So I create this one base on the npm source file.
